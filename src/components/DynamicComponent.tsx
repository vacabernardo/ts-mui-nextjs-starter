...
import type { Props as DemoProps } from './sections/Demo';

export type Props = CardsSectionProps | HeroSectionProps | DemoProps;
...
const componentsMap: ComponentsMap = {
    ...
    DemoSection: dynamic(() => namedComponent(import('./sections/Demo'), 'Demo'))
};
